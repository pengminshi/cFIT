...
int.out = CFITIntegrate(X.list=exprs.list, r=15, seed=0, verbose=F)
...
# run time 20 min
int.ref.out = CFITIntegrate(X.list=exprs.list[c(1,2,3,5)], r=15, max.niter=100, seed=0, verbose=F)
...
tf.out = CFITTransfer(Xtarget=exprs.list[[4]], Wref=int.ref.out$W, max.niter=100, seed=0, verbose=F)
```
...
```{r, eval=T}
int.out = CFITIntegrate(X.list=data.out$X.list, r=6, max.niter = 100, verbose=F, seed=0) 
