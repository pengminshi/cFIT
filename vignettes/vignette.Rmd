...
knitr::opts_chunk$set(collapse = TRUE, comment = "#>",
                      ...
                      # fig.path='fig/', fig.width=6, fig.height=6,
                      # cache.path='cache/', cache=F, autodep=TRUE, cache.comments=FALSE
                      )
...
```{r, echo=F, fig.width=6, fig.height=4, fig.align='center', fig.cap='Confution matrix comparing the mapped cell type with the reference labels'}
...
```{r, echo=F, fig.align='center', out.width='110%', fig.cap='Simulated data from assumed model with batch effects corrected applying cFIT.'}
