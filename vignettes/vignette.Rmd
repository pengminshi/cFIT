...
```{r, echo=F, fig.show="hold",out.width='60%', fig.cap = 'Integrated pancreas islet cells data sests from five technologies.'}
...
```{r, echo=F, fig.show="hold",out.width='60%', fig.cap='cFIT transfer results.'}
...
```{r, echo=F, out.width='80%', fig.align='center', fig.cap='Confution matrix comparing the mapped cell type with the reference labels'}
...
```{r, echo=F, fig.align='center', out.width='100%',fig.cap='Simulated data from assumed model.'}
...
```{r, echo=F, fig.align='center', out.width='100%', fig.cap='Simulated data from assumed model with batch effects corrected applying cFIT.'}
